...
print('-'*30)
anos = int(input("Quanto tempo você quer pagar pelo imovel? "))
...
print(f'{nome.upper()} para financiar uma casa de {casa:.2f} em {anos:.0f} anos a prestação mensal será de R$ {parcelas:.2f} por mês \n')
